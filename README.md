...
見張る作業は機械に任せて、**人間は「見つけたらすぐ申し込む」という本当に大事な一手に集中できます。**

なお**申込みは電話では受け付けていません**（公式FAQ「電話によるお申込みは受け付けておりません」）。
押さえるには、物件ページの「ネットで仮申込」ボタンから申し込むか、UR営業センターの窓口に
出向く必要があります。通知が来てから動く先が電話ではない点だけ、間違えないようにしてください。
